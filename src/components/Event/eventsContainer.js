          ...
          {posts.map((event, i) => (
            <div key={i}>
              ...
              <div className="m-6">
                ...
                <p className="text-sm opacity-50 mt-2">{event.description}</p>
              </div>
            </div>
          ))}
        </div>
      </Fade>
      {/* <div className="w-auto p-8 m-4 h-72 sm:h-96 xs:h-96 xxs:h-96 mt-10 bg-gradient-to-r from-sky to-darksky rounded-xl flex flex-col items-center justify-center">
        ...
        <div className="text-black hover:text-white mt-10 flex flex-col items-center justify-center">
          ...
          <a
            href="#"
            className="mt-4 transition-all duration-500ms ease-in-out hover:ease-in-out inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-black hover:text-white rounded-lg border border-sky  hover:bg-sky"
          >
            Join The List
          </a>
        </div>
